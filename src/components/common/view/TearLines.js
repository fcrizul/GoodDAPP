...
export default class TearLines extends Component {
  constructor(props) {
    super(props)
    this.state = {
      width: 0,
  ...
  render() {
    ...
    return (
      <View
        style={[
          { overflow: 'hidden', width: this.state.width },
          styles.container,
          this.props.isUnder
            ? {
                marginTop: margin,
      ...
      >
        ...
        <View
          style={[
            ...
            styles.rightEnds,
            this.props.tearSize && {
              width: this.props.tearSize - this.offset,
